...
public class SetParameterAttributes extends RPCMethod
{
    /* 实例
    ...
    protected void addField2Body(Element body, SoapMessageModel soapMessageModel)
    {
        ...
        if(setParamAttrList.size() > 0)
        {
        	...
        	getArrayTypeAttributeToCPE(paramElement, SetParameterAttributesStruct, setParamAttrList.size());
        	for (SetParameterAttributesStruct spa : setParamAttrList)
	        {
	            ...
	            getArrayTypeAttributeToCPE(accessListItem, STR, accessArray.length);
	...
	public void setSetParamAttrList(List<SetParameterAttributesStruct> setParamAttrList) {
		this.setParamAttrList = setParamAttrList;
	}
