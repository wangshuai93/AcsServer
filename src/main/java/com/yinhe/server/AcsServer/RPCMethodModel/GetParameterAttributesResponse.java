 ...
 * @author Slive
 */
public class GetParameterAttributesResponse extends RPCMethod
{
	private static final long serialVersionUID = 4386887185073866809L;

	private static final String ParameterList = "ParameterList";
	private static final String ParameterAttributesStruct = "ParameterAttributeStruct";
	private static final String ParameterAttributesStruct2 = "ParameterAttributesStruct";
    ...
    protected void addField2Body(Element body, SoapMessageModel soapMessageModel)
    {
        ...
        {
        	getArrayTypeAttributeToCPE(paramElement,ParameterAttributesStruct,paramAttrList.size());
	        for (ParameterAttributeStruct pas : paramAttrList)
	        {
	            ...
	            getArrayTypeAttributeToCPE(paramAttrStructElement,STR,accessArray.length);
    ...
    protected void parseBody2Filed(Element body, SoapMessageModel soapMessageModel)
    {
        ...
        for(int index =0;index<nodeList.getLength();index ++)
        {
            ...
            if (item.getNodeName().equals(ParameterAttributesStruct) || item.getNodeName().equals(ParameterAttributesStruct2))
            {
