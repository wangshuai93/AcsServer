...
(function($) {
        ...
        var dfop =
            {
                ...
                /**
 	             * @description {Event} afterCheckBoxClick:function(tree, item, status)
 	             * Fired when check box is clicked on.
 	             * @param {Object} tree This tree object. 
 	             * @param {Object} item Node item clicked on.
 	             * @param {Number} status 1 for checked, 0 for unchecked.	 	             
                */
                afterCheckBoxClick: false,
                /**
        ...
        function nodeclick(e) {
            ...
            if (et.tagName == "IMG") {
                ...
                else if ($(et).hasClass("bbit-tree-node-cb")) // click on checkbox
                {
                    ...
                    if (dfop.afterCheckBoxClick) {
                        r = dfop.afterCheckBoxClick.call(et, item, s);
                    }
                }
            }
            else {
    ...
    //================
    $.fn.expendeAll = function() {
    	console.log("expendeAll");
    	$(".bbit-tree-node-expanded").each(function(){
    		$(this).swapClass("bbit-tree-node-expanded", "bbit-tree-node-collapsed");
    	});
    	$("bbit-tree-elbow-plus").each(function(){
    		$(et).swapClass("bbit-tree-elbow-plus", "bbit-tree-elbow-minus");
    	});
    }
...
//    	});
    	...
    	$(".bbit-tree-ec-icon").each(function(){
    		$(this).click();
    	});
    }
